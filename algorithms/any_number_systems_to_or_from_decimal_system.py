...
def chose(way, n, system):
    if way=="d":
        print("From decimal to your number system: ", num_sys(n, 10, system))
    elif way=="s":
        print("From your number system to decimal system: ", num_sys(n, system, 10))
